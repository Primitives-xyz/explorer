  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'fixed left-1/2 top-1/2 z-50 w-[90vw] max-w-xs -translate-x-1/2 -translate-y-1/2 grid gap-5 border border-foreground/20 bg-modal backdrop-blur-2xl text-modal-foreground p-6 shadow-lg rounded outline-none',
          {
