...
export type SseStake = {
  ...
  errors: [
    ...
    },
    {
      ...
      msg: 'investor token mint error'
    },
    {
      code: 6003
      name: 'depositinvestorTokenOwnerError'
      msg: 'investor token owner error'
    },
    {
      code: 6004
      name: 'depositinvestorTokenAmountError'
      msg: 'investor token Amount error'
    },
    {
      code: 6005
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            name: 'dailyDeposits'
            docs: [
              'Array of daily trading fee deposits (30 days rolling window)'
            ]
            type: {
              array: ['u64', 30]
            }
          },
          {
            ...
            docs: ['Current index in the daily_deposits array']
            type: 'u8'
          },
          {
            name: 'lastDepositDay'
            docs: ['Last day when deposits were updated']
            type: 'i64'
          },
          {
            name: 'avgDailyDeposit'
            docs: ['Average daily deposit over the rolling window']
            type: 'u64'
          }
        ]
      }
