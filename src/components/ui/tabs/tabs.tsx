...
const tabsVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap border-b border-b-border/30 text-muted-foreground hover:bg-primary/5 hover:text-primary/80 px-3 h-full ring-offset-background transition-all focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer text-sm font-mono shrink-0',
  {
    variants: {
      variant: {
        default:
