...
export const StakeForm = ({
    ...
    const { isLoggedIn, sdkHasLoaded, primaryWallet, walletAddress } = useCurrentWallet()
    ...
    return (
        <div>
            <span className="text-sm font-medium hover:text-green-500">{t('trade.about_title')}</span>
            <div className="flex flex-col gap-2 border bg-green-900/20 border-green-500/20 rounded-lg p-3 my-3">
                <p className="flex flex-row justify-between items-center">
                    {t('trade.about_content')}
                </p>
            </div>
            <AmountInput
                value={displayAmount}
