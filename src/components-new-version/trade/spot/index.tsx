...
import { TokenSearch } from '@/components-new-version/transactions/swap/token-search';
      ...
      <div className='flex flex-row gap-4 justify-between'>
        <div className='flex flex-col gap-4 w-[600px]'>
          <div className='border border-white/20 bg-white/5 rounded-[20px] flex flex-col gap-2 p-4'>
            ...
            {showPriceLightWeightChart && (
              <div className='flex flex-col gap-2'>
                <div className='relative border border-white/20 bg-white/5 rounded-[12px] p-4'>
                  <button
                    className='w-full px-3 py-2 flex flex-row justify-between items-center'
                  >
                    <div className='flex flex-row justify-center items-center gap-3'>
                    ...
                    <div className='text-[#97EF83]'>
                      {inputTokenUsdPriceLoading ? (
                        <Loader2 className='w-4 h-4 animate-spin' />
                      ) : (
                        inputTokenUsdPrice ? (
                          formatLargeNumber(inputTokenUsdPrice, outputTokenDecimals).toString().concat(" $")
                        ) : ("-- $")
                      )}
                    </div>
                  </button>
                ...
                <div className='relative border border-white/20 bg-white/5 rounded-[12px] p-4'>
                  ...
                  >
                    ...
                    <div className='text-[#97EF83]'>
                      {outputTokenUsdPriceLoading ? (
                        <Loader2 className='w-4 h-4 animate-spin' />
                      ) : (
                        outputTokenUsdPrice ? (
                          formatLargeNumber(outputTokenUsdPrice, outputTokenDecimals).toString().concat(" $")
                        ) : ("-- $")
                      )}
                    </div>
                  </button>
                ...
                <Button
                  variant="outline"
                  className="border-[#97EF83] text-[#97EF83] w-full"
