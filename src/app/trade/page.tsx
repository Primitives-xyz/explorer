...
import { FilterType, TradeLeftContent } from '@/components/trade/left-content/trade-left-content'
...
export default function TradePage() {
  ...
  return (
    <MainContentWrapper className="flex w-full space-x-6 pb-10">
      <TradeLeftContent setTokenMint={setTokenMint} selectedType={selectedType} setSelectedType={setSelectedType} />
