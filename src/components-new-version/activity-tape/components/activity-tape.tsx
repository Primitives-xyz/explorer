...
import { ScrollingText } from '@/components-new-version/ui/scrolling-text'
...
export function ActivityTape() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 inset-x-0 p-2 z-20 backdrop-blur-md overflow-hidden">
      <ScrollingText
