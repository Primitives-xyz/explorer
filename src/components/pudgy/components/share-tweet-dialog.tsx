...
import { ShareImage } from '../../solid-score/components/leaderboard/share-image'
import { ShareInstructions } from '../../solid-score/components/leaderboard/share-instructions'
import { ShareXInstructionsDialog } from '../../solid-score/components/leaderboard/share-x-instructions-dialog'
...
export function ShareTweetDialog({ open, setOpen }: Props) {
